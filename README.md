...
2620030009 - Aaryan Dash
2620030176 - Pushkal Sushanth
...
ATM-Simulator (under this folder) |— README.md |— src | └— ATM.java |— docs |— data |— results |— reports

Execution Instructions:

javac -d out src/ATM.java java -cp out org.example.ATM
